...
if __name__ == '__main__':
  ...
  while pos < packet_len:
    ...
    recv_packet_len = recv_header[4]
    recv_checksum = recv_header[5]
    recv_header = struct.pack('!6H', src_port, dst_port, recv_seq, window_size, recv_packet_len, 0)
    ...
    if calculated == recv_checksum:
      # 문제 없으면
      if sequence_size == 65535:
        sequence_size = window_size * 2 + 1
      if packet_len == 65535:
        packet_len = recv_packet_len
